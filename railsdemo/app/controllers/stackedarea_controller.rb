...
class StackedareaController < ApplicationController
    ...
    def getchart()
        ...
        c = ChartDirector::XYChart.new(300, 210, 0xffffc0, 0x000000)
        ...
        c.addLegend(50, 185, false, "", 8).setBackground(ChartDirector::Transparent)
