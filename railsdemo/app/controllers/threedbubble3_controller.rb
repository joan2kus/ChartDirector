...
class Threedbubble3Controller < ApplicationController

    def index()
        @title = "3D Bubble Chart (3)"
    ...
    def getchart()
        ...
        c.addScatterLayer(dataX0, dataY0, "Technology AAA",
            ChartDirector::SolidSphereShape, 15, 0xff3333).setSymbolScale(dataZ0)
        ...
        c.addScatterLayer(dataX1, dataY1, "Technology BBB",
            ChartDirector::SolidSphereShape, 15, 0x0000ff).setSymbolScale(dataZ1)
