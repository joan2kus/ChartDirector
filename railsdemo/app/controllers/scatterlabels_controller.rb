...
class ScatterlabelsController < ApplicationController

    def index()
        @title = "Custom Scatter Labels"
    ...
    def getchart()
        ...
        layer = c.addScatterLayer(dataX, dataY, "", ChartDirector::GlassSphereShape, 15,
            0xff3333, 0xff3333)
        ...
        textbox.setBackground(0xcc99ff, ChartDirector::Transparent, 1)

        # Put the text box 4 pixels to the right of the data point
        textbox.setAlignment(ChartDirector::Left)
        textbox.setPos(4, 0)
