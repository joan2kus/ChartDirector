...
c.addScatterLayer(dataX0, dataY0, "Technology AAA", ChartDirector::GlassSphereShape,
...
c.addScatterLayer(dataX1, dataY1, "Technology BBB", ChartDirector::GlassSphereShape,
